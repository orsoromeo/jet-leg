...
class HyQKinematics:
    ...
    def update_homogeneous(self, q):
        ...
        self.LF_foot_Xh_fr_trunk[0, 0] = (
            self.c__q_LF_HFE * self.c__q_LF_KFE) - (self.s__q_LF_HFE * self.s__q_LF_KFE)
        self.LF_foot_Xh_fr_trunk[0, 1] = (- self.s__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) - (
            self.s__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE)
        self.LF_foot_Xh_fr_trunk[0, 2] = (- self.c__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) - (
            self.c__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE)
        self.LF_foot_Xh_fr_trunk[0, 3] = (((self.BASE2HAA_offset_x * self.s__q_LF_HFE) + (((self.BASE2HAA_offset_y * self.s__q_LF_HAA) - self.BASE2HAA_offset_z) * self.c__q_LF_HFE) - self.upperLegLength)
                                          * self.s__q_LF_KFE) + (((((self.BASE2HAA_offset_y * self.s__q_LF_HAA) - self.BASE2HAA_offset_z) * self.s__q_LF_HFE) - (self.BASE2HAA_offset_x * self.c__q_LF_HFE)) * self.c__q_LF_KFE)
        self.LF_foot_Xh_fr_trunk[1, 1] = self.c__q_LF_HAA
        self.LF_foot_Xh_fr_trunk[1, 2] = - self.s__q_LF_HAA
        self.LF_foot_Xh_fr_trunk[1, 3] = - \
            self.BASE2HAA_offset_y * self.c__q_LF_HAA
        self.LF_foot_Xh_fr_trunk[2, 0] = (
            self.c__q_LF_HFE * self.s__q_LF_KFE) + (self.s__q_LF_HFE * self.c__q_LF_KFE)
        self.LF_foot_Xh_fr_trunk[2, 1] = (self.s__q_LF_HAA * self.c__q_LF_HFE * self.c__q_LF_KFE) - (
            self.s__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE)
        self.LF_foot_Xh_fr_trunk[2, 2] = (self.c__q_LF_HAA * self.c__q_LF_HFE * self.c__q_LF_KFE) - (
            self.c__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE)
        self.LF_foot_Xh_fr_trunk[2, 3] = (((((self.BASE2HAA_offset_y * self.s__q_LF_HAA) - self.BASE2HAA_offset_z) * self.s__q_LF_HFE) - (self.BASE2HAA_offset_x * self.c__q_LF_HFE)) * self.s__q_LF_KFE) + (
            ((- self.BASE2HAA_offset_x * self.s__q_LF_HFE) + ((self.BASE2HAA_offset_z - (self.BASE2HAA_offset_y * self.s__q_LF_HAA)) * self.c__q_LF_HFE) + self.upperLegLength) * self.c__q_LF_KFE) + self.lowerLegLength

        self.RF_foot_Xh_fr_trunk[0, 0] = (
            self.c__q_RF_HFE * self.c__q_RF_KFE) - (self.s__q_RF_HFE * self.s__q_RF_KFE)
        self.RF_foot_Xh_fr_trunk[0, 1] = (self.s__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) + (
            self.s__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE)
        self.RF_foot_Xh_fr_trunk[0, 2] = (- self.c__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) - (
            self.c__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE)
        ...
        self.RF_foot_Xh_fr_trunk[1,
                                 3] = self.BASE2HAA_offset_y * self.c__q_RF_HAA
        self.RF_foot_Xh_fr_trunk[2, 0] = (
            self.c__q_RF_HFE * self.s__q_RF_KFE) + (self.s__q_RF_HFE * self.c__q_RF_KFE)
        self.RF_foot_Xh_fr_trunk[2, 1] = (self.s__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) - (
            self.s__q_RF_HAA * self.c__q_RF_HFE * self.c__q_RF_KFE)
        self.RF_foot_Xh_fr_trunk[2, 2] = (self.c__q_RF_HAA * self.c__q_RF_HFE * self.c__q_RF_KFE) - (
            self.c__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE)
        self.RF_foot_Xh_fr_trunk[2, 3] = (((((self.BASE2HAA_offset_y * self.s__q_RF_HAA) - self.BASE2HAA_offset_z) * self.s__q_RF_HFE) - (self.BASE2HAA_offset_x * self.c__q_RF_HFE)) * self.s__q_RF_KFE) + (
            ((- self.BASE2HAA_offset_x * self.s__q_RF_HFE) + ((self.BASE2HAA_offset_z - (self.BASE2HAA_offset_y * self.s__q_RF_HAA)) * self.c__q_RF_HFE) + self.upperLegLength) * self.c__q_RF_KFE) + self.lowerLegLength

        self.LH_foot_Xh_fr_trunk[0, 0] = (
            self.c__q_LH_HFE * self.c__q_LH_KFE) - (self.s__q_LH_HFE * self.s__q_LH_KFE)
        self.LH_foot_Xh_fr_trunk[0, 1] = (- self.s__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) - (
            self.s__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE)
        self.LH_foot_Xh_fr_trunk[0, 2] = (- self.c__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) - (
            self.c__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE)
        ...
        self.LH_foot_Xh_fr_trunk[1, 3] = - \
            self.BASE2HAA_offset_y * self.c__q_LH_HAA
        self.LH_foot_Xh_fr_trunk[2, 0] = (
            self.c__q_LH_HFE * self.s__q_LH_KFE) + (self.s__q_LH_HFE * self.c__q_LH_KFE)
        self.LH_foot_Xh_fr_trunk[2, 1] = (self.s__q_LH_HAA * self.c__q_LH_HFE * self.c__q_LH_KFE) - (
            self.s__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE)
        self.LH_foot_Xh_fr_trunk[2, 2] = (self.c__q_LH_HAA * self.c__q_LH_HFE * self.c__q_LH_KFE) - (
            self.c__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE)
        self.LH_foot_Xh_fr_trunk[2, 3] = (((((self.BASE2HAA_offset_y * self.s__q_LH_HAA) - self.BASE2HAA_offset_z) * self.s__q_LH_HFE) + (self.BASE2HAA_offset_x * self.c__q_LH_HFE)) * self.s__q_LH_KFE) + (
            ((self.BASE2HAA_offset_x * self.s__q_LH_HFE) + ((self.BASE2HAA_offset_z - (self.BASE2HAA_offset_y * self.s__q_LH_HAA)) * self.c__q_LH_HFE) + self.upperLegLength) * self.c__q_LH_KFE) + self.lowerLegLength

        self.RH_foot_Xh_fr_trunk[0, 0] = (
            self.c__q_RH_HFE * self.c__q_RH_KFE) - (self.s__q_RH_HFE * self.s__q_RH_KFE)
        self.RH_foot_Xh_fr_trunk[0, 1] = (self.s__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) + (
            self.s__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE)
        self.RH_foot_Xh_fr_trunk[0, 2] = (- self.c__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) - (
            self.c__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE)
        self.RH_foot_Xh_fr_trunk[0, 3] = (((- self.BASE2HAA_offset_x * self.s__q_RH_HFE) + (((self.BASE2HAA_offset_y * self.s__q_RH_HAA) - self.BASE2HAA_offset_z) * self.c__q_RH_HFE) - self.upperLegLength)
                                          * self.s__q_RH_KFE) + (((((self.BASE2HAA_offset_y * self.s__q_RH_HAA) - self.BASE2HAA_offset_z) * self.s__q_RH_HFE) + (self.BASE2HAA_offset_x * self.c__q_RH_HFE)) * self.c__q_RH_KFE)
        self.RH_foot_Xh_fr_trunk[1, 1] = self.c__q_RH_HAA
        self.RH_foot_Xh_fr_trunk[1, 2] = self.s__q_RH_HAA
        self.RH_foot_Xh_fr_trunk[1,
                                 3] = self.BASE2HAA_offset_y * self.c__q_RH_HAA
        self.RH_foot_Xh_fr_trunk[2, 0] = (
            self.c__q_RH_HFE * self.s__q_RH_KFE) + (self.s__q_RH_HFE * self.c__q_RH_KFE)
        self.RH_foot_Xh_fr_trunk[2, 1] = (self.s__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) - (
            self.s__q_RH_HAA * self.c__q_RH_HFE * self.c__q_RH_KFE)
        self.RH_foot_Xh_fr_trunk[2, 2] = (self.c__q_RH_HAA * self.c__q_RH_HFE * self.c__q_RH_KFE) - (
            self.c__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE)
        self.RH_foot_Xh_fr_trunk[2, 3] = (((((self.BASE2HAA_offset_y * self.s__q_RH_HAA) - self.BASE2HAA_offset_z) * self.s__q_RH_HFE) + (self.BASE2HAA_offset_x * self.c__q_RH_HFE)) * self.s__q_RH_KFE) + (
            ((self.BASE2HAA_offset_x * self.s__q_RH_HFE) + ((self.BASE2HAA_offset_z - (self.BASE2HAA_offset_y * self.s__q_RH_HAA)) * self.c__q_RH_HFE) + self.upperLegLength) * self.c__q_RH_KFE) + self.lowerLegLength

        self.fr_trunk_Xh_LF_foot[0, 0] = (
            self.c__q_LF_HFE * self.c__q_LF_KFE) - (self.s__q_LF_HFE * self.s__q_LF_KFE)
        self.fr_trunk_Xh_LF_foot[0, 2] = (
            self.c__q_LF_HFE * self.s__q_LF_KFE) + (self.s__q_LF_HFE * self.c__q_LF_KFE)
        self.fr_trunk_Xh_LF_foot[0, 3] = (- self.lowerLegLength * self.c__q_LF_HFE * self.s__q_LF_KFE) - (
            self.lowerLegLength * self.s__q_LF_HFE * self.c__q_LF_KFE) - (self.upperLegLength * self.s__q_LF_HFE) + self.BASE2HAA_offset_x
        self.fr_trunk_Xh_LF_foot[1, 0] = (- self.s__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) - (
            self.s__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE)
        self.fr_trunk_Xh_LF_foot[1, 1] = self.c__q_LF_HAA
        self.fr_trunk_Xh_LF_foot[1, 2] = (self.s__q_LF_HAA * self.c__q_LF_HFE * self.c__q_LF_KFE) - (
            self.s__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE)
        self.fr_trunk_Xh_LF_foot[1, 3] = (self.lowerLegLength * self.s__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE) - (self.lowerLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE *
                                                                                                                           self.c__q_LF_KFE) - (self.upperLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE) - (self.BASE2HAA_offset_z * self.s__q_LF_HAA) + self.BASE2HAA_offset_y
        self.fr_trunk_Xh_LF_foot[2, 0] = (- self.c__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) - (
            self.c__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE)
        self.fr_trunk_Xh_LF_foot[2, 1] = - self.s__q_LF_HAA
        self.fr_trunk_Xh_LF_foot[2, 2] = (self.c__q_LF_HAA * self.c__q_LF_HFE * self.c__q_LF_KFE) - (
            self.c__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE)
        self.fr_trunk_Xh_LF_foot[2, 3] = (self.lowerLegLength * self.c__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE) - (self.lowerLegLength * self.c__q_LF_HAA *
                                                                                                                           self.c__q_LF_HFE * self.c__q_LF_KFE) - (self.upperLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE) - (self.BASE2HAA_offset_z * self.c__q_LF_HAA)

        self.fr_trunk_Xh_fr_LF_HFE[1, 0] = - self.s__q_LF_HAA
        self.fr_trunk_Xh_fr_LF_HFE[1, 2] = self.c__q_LF_HAA
        self.fr_trunk_Xh_fr_LF_HFE[1, 3] = self.BASE2HAA_offset_y - \
            (self.BASE2HAA_offset_z * self.s__q_LF_HAA)
        self.fr_trunk_Xh_fr_LF_HFE[2, 0] = - self.c__q_LF_HAA
        self.fr_trunk_Xh_fr_LF_HFE[2, 2] = - self.s__q_LF_HAA
        self.fr_trunk_Xh_fr_LF_HFE[2, 3] = - \
            self.BASE2HAA_offset_z * self.c__q_LF_HAA

        self.fr_trunk_Xh_fr_LF_KFE[0, 0] = - self.s__q_LF_HFE
        self.fr_trunk_Xh_fr_LF_KFE[0, 1] = - self.c__q_LF_HFE
        self.fr_trunk_Xh_fr_LF_KFE[0, 3] = self.BASE2HAA_offset_x - \
            (self.upperLegLength * self.s__q_LF_HFE)
        self.fr_trunk_Xh_fr_LF_KFE[1, 0] = - \
            self.s__q_LF_HAA * self.c__q_LF_HFE
        self.fr_trunk_Xh_fr_LF_KFE[1, 1] = self.s__q_LF_HAA * self.s__q_LF_HFE
        self.fr_trunk_Xh_fr_LF_KFE[1, 2] = self.c__q_LF_HAA
        self.fr_trunk_Xh_fr_LF_KFE[1, 3] = (- self.upperLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE) - (
            self.BASE2HAA_offset_z * self.s__q_LF_HAA) + self.BASE2HAA_offset_y
        self.fr_trunk_Xh_fr_LF_KFE[2, 0] = - \
            self.c__q_LF_HAA * self.c__q_LF_HFE
        self.fr_trunk_Xh_fr_LF_KFE[2, 1] = self.c__q_LF_HAA * self.s__q_LF_HFE
        self.fr_trunk_Xh_fr_LF_KFE[2, 2] = - self.s__q_LF_HAA
        self.fr_trunk_Xh_fr_LF_KFE[2, 3] = (- self.upperLegLength * self.c__q_LF_HAA *
                                            self.c__q_LF_HFE) - (self.BASE2HAA_offset_z * self.c__q_LF_HAA)

        self.fr_trunk_Xh_RF_foot[0, 0] = (
            self.c__q_RF_HFE * self.c__q_RF_KFE) - (self.s__q_RF_HFE * self.s__q_RF_KFE)
        self.fr_trunk_Xh_RF_foot[0, 2] = (
            self.c__q_RF_HFE * self.s__q_RF_KFE) + (self.s__q_RF_HFE * self.c__q_RF_KFE)
        self.fr_trunk_Xh_RF_foot[0, 3] = (- self.lowerLegLength * self.c__q_RF_HFE * self.s__q_RF_KFE) - (
            self.lowerLegLength * self.s__q_RF_HFE * self.c__q_RF_KFE) - (self.upperLegLength * self.s__q_RF_HFE) + self.BASE2HAA_offset_x
        self.fr_trunk_Xh_RF_foot[1, 0] = (self.s__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) + (
            self.s__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE)
        self.fr_trunk_Xh_RF_foot[1, 1] = self.c__q_RF_HAA
        self.fr_trunk_Xh_RF_foot[1, 2] = (self.s__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) - (
            self.s__q_RF_HAA * self.c__q_RF_HFE * self.c__q_RF_KFE)
        self.fr_trunk_Xh_RF_foot[1, 3] = (- self.lowerLegLength * self.s__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) + (self.lowerLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE *
                                                                                                                             self.c__q_RF_KFE) + (self.upperLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE) + (self.BASE2HAA_offset_z * self.s__q_RF_HAA) - self.BASE2HAA_offset_y
        self.fr_trunk_Xh_RF_foot[2, 0] = (- self.c__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) - (
            self.c__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE)
        self.fr_trunk_Xh_RF_foot[2, 1] = self.s__q_RF_HAA
        self.fr_trunk_Xh_RF_foot[2, 2] = (self.c__q_RF_HAA * self.c__q_RF_HFE * self.c__q_RF_KFE) - (
            self.c__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE)
        self.fr_trunk_Xh_RF_foot[2, 3] = (self.lowerLegLength * self.c__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) - (self.lowerLegLength * self.c__q_RF_HAA *
                                                                                                                           self.c__q_RF_HFE * self.c__q_RF_KFE) - (self.upperLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE) - (self.BASE2HAA_offset_z * self.c__q_RF_HAA)

        self.fr_trunk_Xh_fr_RF_HFE[1, 0] = self.s__q_RF_HAA
        self.fr_trunk_Xh_fr_RF_HFE[1, 2] = self.c__q_RF_HAA
        self.fr_trunk_Xh_fr_RF_HFE[1, 3] = (
            self.BASE2HAA_offset_z * self.s__q_RF_HAA) - self.BASE2HAA_offset_y
        self.fr_trunk_Xh_fr_RF_HFE[2, 0] = - self.c__q_RF_HAA
        self.fr_trunk_Xh_fr_RF_HFE[2, 2] = self.s__q_RF_HAA
        self.fr_trunk_Xh_fr_RF_HFE[2, 3] = - \
            self.BASE2HAA_offset_z * self.c__q_RF_HAA

        self.fr_trunk_Xh_fr_RF_KFE[0, 0] = - self.s__q_RF_HFE
        self.fr_trunk_Xh_fr_RF_KFE[0, 1] = - self.c__q_RF_HFE
        self.fr_trunk_Xh_fr_RF_KFE[0, 3] = self.BASE2HAA_offset_x - \
            (self.upperLegLength * self.s__q_RF_HFE)
        self.fr_trunk_Xh_fr_RF_KFE[1, 0] = self.s__q_RF_HAA * self.c__q_RF_HFE
        self.fr_trunk_Xh_fr_RF_KFE[1, 1] = - \
            self.s__q_RF_HAA * self.s__q_RF_HFE
        self.fr_trunk_Xh_fr_RF_KFE[1, 2] = self.c__q_RF_HAA
        self.fr_trunk_Xh_fr_RF_KFE[1, 3] = (self.upperLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE) + (
            self.BASE2HAA_offset_z * self.s__q_RF_HAA) - self.BASE2HAA_offset_y
        self.fr_trunk_Xh_fr_RF_KFE[2, 0] = - \
            self.c__q_RF_HAA * self.c__q_RF_HFE
        self.fr_trunk_Xh_fr_RF_KFE[2, 1] = self.c__q_RF_HAA * self.s__q_RF_HFE
        self.fr_trunk_Xh_fr_RF_KFE[2, 2] = self.s__q_RF_HAA
        self.fr_trunk_Xh_fr_RF_KFE[2, 3] = (- self.upperLegLength * self.c__q_RF_HAA *
                                            self.c__q_RF_HFE) - (self.BASE2HAA_offset_z * self.c__q_RF_HAA)

        self.fr_trunk_Xh_LH_foot[0, 0] = (
            self.c__q_LH_HFE * self.c__q_LH_KFE) - (self.s__q_LH_HFE * self.s__q_LH_KFE)
        self.fr_trunk_Xh_LH_foot[0, 2] = (
            self.c__q_LH_HFE * self.s__q_LH_KFE) + (self.s__q_LH_HFE * self.c__q_LH_KFE)
        self.fr_trunk_Xh_LH_foot[0, 3] = (- self.lowerLegLength * self.c__q_LH_HFE * self.s__q_LH_KFE) - (
            self.lowerLegLength * self.s__q_LH_HFE * self.c__q_LH_KFE) - (self.upperLegLength * self.s__q_LH_HFE) - self.BASE2HAA_offset_x
        self.fr_trunk_Xh_LH_foot[1, 0] = (- self.s__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) - (
            self.s__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE)
        self.fr_trunk_Xh_LH_foot[1, 1] = self.c__q_LH_HAA
        self.fr_trunk_Xh_LH_foot[1, 2] = (self.s__q_LH_HAA * self.c__q_LH_HFE * self.c__q_LH_KFE) - (
            self.s__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE)
        self.fr_trunk_Xh_LH_foot[1, 3] = (self.lowerLegLength * self.s__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE) - (self.lowerLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE *
                                                                                                                           self.c__q_LH_KFE) - (self.upperLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE) - (self.BASE2HAA_offset_z * self.s__q_LH_HAA) + self.BASE2HAA_offset_y
        self.fr_trunk_Xh_LH_foot[2, 0] = (- self.c__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) - (
            self.c__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE)
        self.fr_trunk_Xh_LH_foot[2, 1] = - self.s__q_LH_HAA
        self.fr_trunk_Xh_LH_foot[2, 2] = (self.c__q_LH_HAA * self.c__q_LH_HFE * self.c__q_LH_KFE) - (
            self.c__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE)
        self.fr_trunk_Xh_LH_foot[2, 3] = (self.lowerLegLength * self.c__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE) - (self.lowerLegLength * self.c__q_LH_HAA *
                                                                                                                           self.c__q_LH_HFE * self.c__q_LH_KFE) - (self.upperLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE) - (self.BASE2HAA_offset_z * self.c__q_LH_HAA)

        self.fr_trunk_Xh_fr_LH_HFE[1, 0] = - self.s__q_LH_HAA
        self.fr_trunk_Xh_fr_LH_HFE[1, 2] = self.c__q_LH_HAA
        self.fr_trunk_Xh_fr_LH_HFE[1, 3] = self.BASE2HAA_offset_y - \
            (self.BASE2HAA_offset_z * self.s__q_LH_HAA)
        self.fr_trunk_Xh_fr_LH_HFE[2, 0] = - self.c__q_LH_HAA
        self.fr_trunk_Xh_fr_LH_HFE[2, 2] = - self.s__q_LH_HAA
        self.fr_trunk_Xh_fr_LH_HFE[2, 3] = - \
            self.BASE2HAA_offset_z * self.c__q_LH_HAA

        self.fr_trunk_Xh_fr_LH_KFE[0, 0] = - self.s__q_LH_HFE
        self.fr_trunk_Xh_fr_LH_KFE[0, 1] = - self.c__q_LH_HFE
        self.fr_trunk_Xh_fr_LH_KFE[0, 3] = (
            - self.upperLegLength * self.s__q_LH_HFE) - self.BASE2HAA_offset_x
        self.fr_trunk_Xh_fr_LH_KFE[1, 0] = - \
            self.s__q_LH_HAA * self.c__q_LH_HFE
        self.fr_trunk_Xh_fr_LH_KFE[1, 1] = self.s__q_LH_HAA * self.s__q_LH_HFE
        self.fr_trunk_Xh_fr_LH_KFE[1, 2] = self.c__q_LH_HAA
        self.fr_trunk_Xh_fr_LH_KFE[1, 3] = (- self.upperLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE) - (
            self.BASE2HAA_offset_z * self.s__q_LH_HAA) + self.BASE2HAA_offset_y
        self.fr_trunk_Xh_fr_LH_KFE[2, 0] = - \
            self.c__q_LH_HAA * self.c__q_LH_HFE
        self.fr_trunk_Xh_fr_LH_KFE[2, 1] = self.c__q_LH_HAA * self.s__q_LH_HFE
        self.fr_trunk_Xh_fr_LH_KFE[2, 2] = - self.s__q_LH_HAA
        self.fr_trunk_Xh_fr_LH_KFE[2, 3] = (- self.upperLegLength * self.c__q_LH_HAA *
                                            self.c__q_LH_HFE) - (self.BASE2HAA_offset_z * self.c__q_LH_HAA)

        self.fr_trunk_Xh_RH_foot[0, 0] = (
            self.c__q_RH_HFE * self.c__q_RH_KFE) - (self.s__q_RH_HFE * self.s__q_RH_KFE)
        self.fr_trunk_Xh_RH_foot[0, 2] = (
            self.c__q_RH_HFE * self.s__q_RH_KFE) + (self.s__q_RH_HFE * self.c__q_RH_KFE)
        self.fr_trunk_Xh_RH_foot[0, 3] = (- self.lowerLegLength * self.c__q_RH_HFE * self.s__q_RH_KFE) - (
            self.lowerLegLength * self.s__q_RH_HFE * self.c__q_RH_KFE) - (self.upperLegLength * self.s__q_RH_HFE) - self.BASE2HAA_offset_x
        self.fr_trunk_Xh_RH_foot[1, 0] = (self.s__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) + (
            self.s__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE)
        self.fr_trunk_Xh_RH_foot[1, 1] = self.c__q_RH_HAA
        self.fr_trunk_Xh_RH_foot[1, 2] = (self.s__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) - (
            self.s__q_RH_HAA * self.c__q_RH_HFE * self.c__q_RH_KFE)
        self.fr_trunk_Xh_RH_foot[1, 3] = (- self.lowerLegLength * self.s__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) + (self.lowerLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE *
                                                                                                                             self.c__q_RH_KFE) + (self.upperLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE) + (self.BASE2HAA_offset_z * self.s__q_RH_HAA) - self.BASE2HAA_offset_y
        self.fr_trunk_Xh_RH_foot[2, 0] = (- self.c__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) - (
            self.c__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE)
        self.fr_trunk_Xh_RH_foot[2, 1] = self.s__q_RH_HAA
        self.fr_trunk_Xh_RH_foot[2, 2] = (self.c__q_RH_HAA * self.c__q_RH_HFE * self.c__q_RH_KFE) - (
            self.c__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE)
        self.fr_trunk_Xh_RH_foot[2, 3] = (self.lowerLegLength * self.c__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) - (self.lowerLegLength * self.c__q_RH_HAA *
                                                                                                                           self.c__q_RH_HFE * self.c__q_RH_KFE) - (self.upperLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE) - (self.BASE2HAA_offset_z * self.c__q_RH_HAA)

        self.fr_trunk_Xh_fr_RH_HFE[1, 0] = self.s__q_RH_HAA
        self.fr_trunk_Xh_fr_RH_HFE[1, 2] = self.c__q_RH_HAA
        self.fr_trunk_Xh_fr_RH_HFE[1, 3] = (
            self.BASE2HAA_offset_z * self.s__q_RH_HAA) - self.BASE2HAA_offset_y
        self.fr_trunk_Xh_fr_RH_HFE[2, 0] = - self.c__q_RH_HAA
        self.fr_trunk_Xh_fr_RH_HFE[2, 2] = self.s__q_RH_HAA
        self.fr_trunk_Xh_fr_RH_HFE[2, 3] = - \
            self.BASE2HAA_offset_z * self.c__q_RH_HAA

        self.fr_trunk_Xh_fr_RH_KFE[0, 0] = - self.s__q_RH_HFE
        self.fr_trunk_Xh_fr_RH_KFE[0, 1] = - self.c__q_RH_HFE
        self.fr_trunk_Xh_fr_RH_KFE[0, 3] = (
            - self.upperLegLength * self.s__q_RH_HFE) - self.BASE2HAA_offset_x
        self.fr_trunk_Xh_fr_RH_KFE[1, 0] = self.s__q_RH_HAA * self.c__q_RH_HFE
        self.fr_trunk_Xh_fr_RH_KFE[1, 1] = - \
            self.s__q_RH_HAA * self.s__q_RH_HFE
        self.fr_trunk_Xh_fr_RH_KFE[1, 2] = self.c__q_RH_HAA
        self.fr_trunk_Xh_fr_RH_KFE[1, 3] = (self.upperLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE) + (
            self.BASE2HAA_offset_z * self.s__q_RH_HAA) - self.BASE2HAA_offset_y
        self.fr_trunk_Xh_fr_RH_KFE[2, 0] = - \
            self.c__q_RH_HAA * self.c__q_RH_HFE
        self.fr_trunk_Xh_fr_RH_KFE[2, 1] = self.c__q_RH_HAA * self.s__q_RH_HFE
        self.fr_trunk_Xh_fr_RH_KFE[2, 2] = self.s__q_RH_HAA
        self.fr_trunk_Xh_fr_RH_KFE[2, 3] = (- self.upperLegLength * self.c__q_RH_HAA *
                                            self.c__q_RH_HFE) - (self.BASE2HAA_offset_z * self.c__q_RH_HAA)

        self.fr_LF_hipassembly_Xh_fr_trunk[0, 1] = - self.s__q_LF_HAA
        self.fr_LF_hipassembly_Xh_fr_trunk[0, 2] = - self.c__q_LF_HAA
        self.fr_LF_hipassembly_Xh_fr_trunk[0,
                                           3] = self.BASE2HAA_offset_y * self.s__q_LF_HAA
        self.fr_LF_hipassembly_Xh_fr_trunk[1, 1] = - self.c__q_LF_HAA
        self.fr_LF_hipassembly_Xh_fr_trunk[1, 2] = self.s__q_LF_HAA
        self.fr_LF_hipassembly_Xh_fr_trunk[1,
                                           3] = self.BASE2HAA_offset_y * self.c__q_LF_HAA
        ...
        self.fr_LF_upperleg_Xh_fr_LF_hipassembly[0, 3] = - \
            self.BASE2HAA_offset_z * self.c__q_LF_HFE
        ...
        self.fr_LF_upperleg_Xh_fr_LF_hipassembly[1,
                                                 3] = self.BASE2HAA_offset_z * self.s__q_LF_HFE
        ...
        self.fr_LF_lowerleg_Xh_fr_LF_upperleg[0, 3] = - \
            self.upperLegLength * self.c__q_LF_KFE
        self.fr_LF_lowerleg_Xh_fr_LF_upperleg[1, 0] = - self.s__q_LF_KFE
        self.fr_LF_lowerleg_Xh_fr_LF_upperleg[1, 1] = self.c__q_LF_KFE
        self.fr_LF_lowerleg_Xh_fr_LF_upperleg[1,
                                              3] = self.upperLegLength * self.s__q_LF_KFE
        ...
        self.fr_RF_hipassembly_Xh_fr_trunk[0,
                                           3] = self.BASE2HAA_offset_y * self.s__q_RF_HAA
        self.fr_RF_hipassembly_Xh_fr_trunk[1, 1] = self.c__q_RF_HAA
        self.fr_RF_hipassembly_Xh_fr_trunk[1, 2] = self.s__q_RF_HAA
        self.fr_RF_hipassembly_Xh_fr_trunk[1,
                                           3] = self.BASE2HAA_offset_y * self.c__q_RF_HAA
        ...
        self.fr_RF_upperleg_Xh_fr_RF_hipassembly[0, 3] = - \
            self.BASE2HAA_offset_z * self.c__q_RF_HFE
        ...
        self.fr_RF_upperleg_Xh_fr_RF_hipassembly[1,
                                                 3] = self.BASE2HAA_offset_z * self.s__q_RF_HFE
        ...
        self.fr_RF_lowerleg_Xh_fr_RF_upperleg[0, 3] = - \
            self.upperLegLength * self.c__q_RF_KFE
        self.fr_RF_lowerleg_Xh_fr_RF_upperleg[1, 0] = - self.s__q_RF_KFE
        self.fr_RF_lowerleg_Xh_fr_RF_upperleg[1, 1] = self.c__q_RF_KFE
        self.fr_RF_lowerleg_Xh_fr_RF_upperleg[1,
                                              3] = self.upperLegLength * self.s__q_RF_KFE
        ...
        self.fr_LH_hipassembly_Xh_fr_trunk[0,
                                           3] = self.BASE2HAA_offset_y * self.s__q_LH_HAA
        self.fr_LH_hipassembly_Xh_fr_trunk[1, 1] = - self.c__q_LH_HAA
        self.fr_LH_hipassembly_Xh_fr_trunk[1, 2] = self.s__q_LH_HAA
        self.fr_LH_hipassembly_Xh_fr_trunk[1,
                                           3] = self.BASE2HAA_offset_y * self.c__q_LH_HAA
        ...
        self.fr_LH_upperleg_Xh_fr_LH_hipassembly[0, 3] = - \
            self.BASE2HAA_offset_z * self.c__q_LH_HFE
        ...
        self.fr_LH_upperleg_Xh_fr_LH_hipassembly[1,
                                                 3] = self.BASE2HAA_offset_z * self.s__q_LH_HFE
        ...
        self.fr_LH_lowerleg_Xh_fr_LH_upperleg[0, 3] = - \
            self.upperLegLength * self.c__q_LH_KFE
        self.fr_LH_lowerleg_Xh_fr_LH_upperleg[1, 0] = - self.s__q_LH_KFE
        self.fr_LH_lowerleg_Xh_fr_LH_upperleg[1, 1] = self.c__q_LH_KFE
        self.fr_LH_lowerleg_Xh_fr_LH_upperleg[1,
                                              3] = self.upperLegLength * self.s__q_LH_KFE
        ...
        self.fr_RH_hipassembly_Xh_fr_trunk[0,
                                           3] = self.BASE2HAA_offset_y * self.s__q_RH_HAA
        self.fr_RH_hipassembly_Xh_fr_trunk[1, 1] = self.c__q_RH_HAA
        self.fr_RH_hipassembly_Xh_fr_trunk[1, 2] = self.s__q_RH_HAA
        self.fr_RH_hipassembly_Xh_fr_trunk[1,
                                           3] = self.BASE2HAA_offset_y * self.c__q_RH_HAA
        ...
        self.fr_RH_upperleg_Xh_fr_RH_hipassembly[0, 3] = - \
            self.BASE2HAA_offset_z * self.c__q_RH_HFE
        ...
        self.fr_RH_upperleg_Xh_fr_RH_hipassembly[1,
                                                 3] = self.BASE2HAA_offset_z * self.s__q_RH_HFE
        ...
        self.fr_RH_lowerleg_Xh_fr_RH_upperleg[0, 3] = - \
            self.upperLegLength * self.c__q_RH_KFE
        self.fr_RH_lowerleg_Xh_fr_RH_upperleg[1, 0] = - self.s__q_RH_KFE
        self.fr_RH_lowerleg_Xh_fr_RH_upperleg[1, 1] = self.c__q_RH_KFE
        self.fr_RH_lowerleg_Xh_fr_RH_upperleg[1,
                                              3] = self.upperLegLength * self.s__q_RH_KFE
    ...
    def update_jacobians(self, q):
        ...
        self.fr_trunk_J_LF_foot[4-1, 2-1] = (self.lowerLegLength * self.s__q_LF_HFE * self.s__q_LF_KFE) - (
            self.lowerLegLength * self.c__q_LF_HFE * self.c__q_LF_KFE) - (self.upperLegLength * self.c__q_LF_HFE)
        self.fr_trunk_J_LF_foot[4-1, 3-1] = (self.lowerLegLength * self.s__q_LF_HFE * self.s__q_LF_KFE) - (
            self.lowerLegLength * self.c__q_LF_HFE * self.c__q_LF_KFE)
        self.fr_trunk_J_LF_foot[5-1, 1-1] = (self.lowerLegLength * self.c__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE) - (self.lowerLegLength * self.c__q_LF_HAA *
                                                                                                                              self.c__q_LF_HFE * self.c__q_LF_KFE) - (self.upperLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE) - (self.BASE2HAA_offset_z * self.c__q_LF_HAA)
        self.fr_trunk_J_LF_foot[5-1, 2-1] = (self.lowerLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) + (
            self.lowerLegLength * self.s__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE) + (self.upperLegLength * self.s__q_LF_HAA * self.s__q_LF_HFE)
        self.fr_trunk_J_LF_foot[5-1, 3-1] = (self.lowerLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) + (
            self.lowerLegLength * self.s__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE)
        self.fr_trunk_J_LF_foot[6-1, 1-1] = (- self.lowerLegLength * self.s__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE) + (self.lowerLegLength * self.s__q_LF_HAA *
                                                                                                                                self.c__q_LF_HFE * self.c__q_LF_KFE) + (self.upperLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE) + (self.BASE2HAA_offset_z * self.s__q_LF_HAA)
        self.fr_trunk_J_LF_foot[6-1, 2-1] = (self.lowerLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) + (
            self.lowerLegLength * self.c__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE) + (self.upperLegLength * self.c__q_LF_HAA * self.s__q_LF_HFE)
        self.fr_trunk_J_LF_foot[6-1, 3-1] = (self.lowerLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) + (
            self.lowerLegLength * self.c__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE)
        ...
        self.fr_trunk_J_RF_foot[4-1, 2-1] = (self.lowerLegLength * self.s__q_RF_HFE * self.s__q_RF_KFE) - (
            self.lowerLegLength * self.c__q_RF_HFE * self.c__q_RF_KFE) - (self.upperLegLength * self.c__q_RF_HFE)
        self.fr_trunk_J_RF_foot[4-1, 3-1] = (self.lowerLegLength * self.s__q_RF_HFE * self.s__q_RF_KFE) - (
            self.lowerLegLength * self.c__q_RF_HFE * self.c__q_RF_KFE)
        self.fr_trunk_J_RF_foot[5-1, 1-1] = (- self.lowerLegLength * self.c__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) + (self.lowerLegLength * self.c__q_RF_HAA *
                                                                                                                                self.c__q_RF_HFE * self.c__q_RF_KFE) + (self.upperLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE) + (self.BASE2HAA_offset_z * self.c__q_RF_HAA)
        self.fr_trunk_J_RF_foot[5-1, 2-1] = (- self.lowerLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) - (
            self.lowerLegLength * self.s__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE) - (self.upperLegLength * self.s__q_RF_HAA * self.s__q_RF_HFE)
        self.fr_trunk_J_RF_foot[5-1, 3-1] = (- self.lowerLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) - (
            self.lowerLegLength * self.s__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE)
        self.fr_trunk_J_RF_foot[6-1, 1-1] = (- self.lowerLegLength * self.s__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) + (self.lowerLegLength * self.s__q_RF_HAA *
                                                                                                                                self.c__q_RF_HFE * self.c__q_RF_KFE) + (self.upperLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE) + (self.BASE2HAA_offset_z * self.s__q_RF_HAA)
        self.fr_trunk_J_RF_foot[6-1, 2-1] = (self.lowerLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) + (
            self.lowerLegLength * self.c__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE) + (self.upperLegLength * self.c__q_RF_HAA * self.s__q_RF_HFE)
        self.fr_trunk_J_RF_foot[6-1, 3-1] = (self.lowerLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) + (
            self.lowerLegLength * self.c__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE)
        ...
        self.fr_trunk_J_LH_foot[4-1, 2-1] = (self.lowerLegLength * self.s__q_LH_HFE * self.s__q_LH_KFE) - (
            self.lowerLegLength * self.c__q_LH_HFE * self.c__q_LH_KFE) - (self.upperLegLength * self.c__q_LH_HFE)
        self.fr_trunk_J_LH_foot[4-1, 3-1] = (self.lowerLegLength * self.s__q_LH_HFE * self.s__q_LH_KFE) - (
            self.lowerLegLength * self.c__q_LH_HFE * self.c__q_LH_KFE)
        self.fr_trunk_J_LH_foot[5-1, 1-1] = (self.lowerLegLength * self.c__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE) - (self.lowerLegLength * self.c__q_LH_HAA *
                                                                                                                              self.c__q_LH_HFE * self.c__q_LH_KFE) - (self.upperLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE) - (self.BASE2HAA_offset_z * self.c__q_LH_HAA)
        self.fr_trunk_J_LH_foot[5-1, 2-1] = (self.lowerLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) + (
            self.lowerLegLength * self.s__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE) + (self.upperLegLength * self.s__q_LH_HAA * self.s__q_LH_HFE)
        self.fr_trunk_J_LH_foot[5-1, 3-1] = (self.lowerLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) + (
            self.lowerLegLength * self.s__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE)
        self.fr_trunk_J_LH_foot[6-1, 1-1] = (- self.lowerLegLength * self.s__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE) + (self.lowerLegLength * self.s__q_LH_HAA *
                                                                                                                                self.c__q_LH_HFE * self.c__q_LH_KFE) + (self.upperLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE) + (self.BASE2HAA_offset_z * self.s__q_LH_HAA)
        self.fr_trunk_J_LH_foot[6-1, 2-1] = (self.lowerLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) + (
            self.lowerLegLength * self.c__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE) + (self.upperLegLength * self.c__q_LH_HAA * self.s__q_LH_HFE)
        self.fr_trunk_J_LH_foot[6-1, 3-1] = (self.lowerLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) + (
            self.lowerLegLength * self.c__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE)
        ...
        self.fr_trunk_J_RH_foot[4-1, 2-1] = (self.lowerLegLength * self.s__q_RH_HFE * self.s__q_RH_KFE) - (
            self.lowerLegLength * self.c__q_RH_HFE * self.c__q_RH_KFE) - (self.upperLegLength * self.c__q_RH_HFE)
        self.fr_trunk_J_RH_foot[4-1, 3-1] = (self.lowerLegLength * self.s__q_RH_HFE * self.s__q_RH_KFE) - (
            self.lowerLegLength * self.c__q_RH_HFE * self.c__q_RH_KFE)
        self.fr_trunk_J_RH_foot[5-1, 1-1] = (- self.lowerLegLength * self.c__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) + (self.lowerLegLength * self.c__q_RH_HAA *
                                                                                                                                self.c__q_RH_HFE * self.c__q_RH_KFE) + (self.upperLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE) + (self.BASE2HAA_offset_z * self.c__q_RH_HAA)
        self.fr_trunk_J_RH_foot[5-1, 2-1] = (- self.lowerLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) - (
            self.lowerLegLength * self.s__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE) - (self.upperLegLength * self.s__q_RH_HAA * self.s__q_RH_HFE)
        self.fr_trunk_J_RH_foot[5-1, 3-1] = (- self.lowerLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) - (
            self.lowerLegLength * self.s__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE)
        self.fr_trunk_J_RH_foot[6-1, 1-1] = (- self.lowerLegLength * self.s__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) + (self.lowerLegLength * self.s__q_RH_HAA *
                                                                                                                                self.c__q_RH_HFE * self.c__q_RH_KFE) + (self.upperLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE) + (self.BASE2HAA_offset_z * self.s__q_RH_HAA)
        self.fr_trunk_J_RH_foot[6-1, 2-1] = (self.lowerLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) + (
            self.lowerLegLength * self.c__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE) + (self.upperLegLength * self.c__q_RH_HAA * self.s__q_RH_HFE)
        self.fr_trunk_J_RH_foot[6-1, 3-1] = (self.lowerLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) + (
            self.lowerLegLength * self.c__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE)
...
#
        ...
        foot_haa_frame = footPositionBF - \
            [self.BASE2HAA_offset_x*haaXOffset_sign_flip[legID],
                self.BASE2HAA_offset_y*haaYOffset_sign_flip[legID], 0.0]

        haa2foot_yz = np.sqrt(np.square(
            foot_haa_frame[self.rbd.LY]) + np.square(foot_haa_frame[self.rbd.LZ]))
        hfe2foot_yz = 0.0
        fe_plane_line = [0.0, foot_haa_frame[self.rbd.LY],
                         foot_haa_frame[self.rbd.LZ]]
...
#            // HFE-to-foot distance, squared and plain
        hfe2foot_sqr = hfe2foot_yz * hfe2foot_yz + \
            foot_haa_frame[self.rbd.LX] * foot_haa_frame[self.rbd.LX]
        hfe2foot = np.sqrt(hfe2foot_sqr)

        ''' HAA '''

        q_leg[self.dog.HAA] = - np.arctan2(
            fe_plane_line[self.rbd.LY], -fe_plane_line[self.rbd.LZ]) * haa_sign_flip[legID]

        ''' HFE '''

        temp = (upleg_length_sqr + hfe2foot_sqr - lowleg_length_sqr) / \
            (2 * self.upperLegLength * hfe2foot)
...
#    //  plane (the line passing through HFE at an angle of PI/2 in HFE conventions)
        if(haa2foot_yz < self.HAA2HFE):
            q_leg[self.dog.HFE] = - M_PI + \
                np.arcsin(foot_x / hfe2foot) + np.arccos(temp)
        else:
            q_leg[self.dog.HFE] = - \
                np.arcsin(foot_x / hfe2foot) + np.arccos(temp)

#    // Now swap the sign again to account for the actual leg
        # // not an errors, use the same sign_flip of KFE
        q_leg[self.dog.HFE] = q_leg[self.dog.HFE] * kfe_sign_flip[legID]
...
#    //  might be slightly outside [-1,1], therefore I cap it.
        temp = (upleg_length_sqr + lowleg_length_sqr -
                hfe2foot_sqr) / twiceUpperLower
#        temp = (temp > 1 ? 1 : (temp < -1 ? -1 : temp));
        if temp > 1:
            temp = 1
        else:
...
#       //Check if the outputs are inf or nan
        for joint in self.dog.legJoints:
            if not np.isfinite(q_leg[joint]):
                print("Position of joint ", joint,
                      " and leg ", 0, " is not finite !!!")
#            return false;
    ...
    def fixedBaseInverseKinematics(self, contactsBF, foot_vel):
        q = []
        for legID in self.dog.legs:
            q_leg = self.leg_inverse_kin(
                legID, contactsBF[legID, :], foot_vel[legID, :])
            q = np.hstack([q, q_leg])
