...
class IterativeProjection:
    ...
    def initiliaze_inner_appriximation(self, constraint_mode, mass, contactsNumber, contacts, com, normals):
        ...
        inner_vertex1, force1 = self.expand_direction(
            constraint_mode, mass, contactsNumber, contacts, com, normals, direction1)
        ...
        inner_vertex2, force2 = self.expand_direction(
            constraint_mode, mass, contactsNumber, contacts, com, normals, direction2)
        ...
        inner_vertex3, force3 = self.expand_direction(
            constraint_mode, mass, contactsNumber, contacts, com, normals, direction3)
    ...
    def expand_direction(self, constraint_mode, mass, contactsNumber, contacts, com, normals, direction):
        ...
        if (not isOutOfWorkspace):
            ...
            G_force, h, isConstraintOk = constraint.inequalities(
                constraint_mode, nc, ng, normals, friction_coeff, J_LF, J_RF, J_LH, J_RH)
