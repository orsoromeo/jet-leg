...
class HyQKinematics:
    ...
    def leg_inverse_kin(self, legID, footPositionBF, footVelocityBF):
        ...
        foot_haa_frame = footPositionBF - [self.BASE2HAA_offset_x * haaXOffset_sign_flip[legID],
        ...
        q_leg[self.dog.HAA] = - np.arctan2(fe_plane_line[self.rbd.LY], -fe_plane_line[self.rbd.LZ]) * haa_sign_flip[
            legID];
        ...
        q_leg[self.dog.HFE] = q_leg[self.dog.HFE] * kfe_sign_flip[
            legID];  # // not an errors, use the same sign_flip of KFE
...
class HyQKinematics:
    ...
    def update_homogeneous(self, q):
        ...
        self.LF_foot_Xh_fr_trunk[0, 3] = (((self.BASE2HAA_offset_x * self.s__q_LF_HFE) + (((
                                                                                                       self.BASE2HAA_offset_y * self.s__q_LF_HAA) - self.BASE2HAA_offset_z) * self.c__q_LF_HFE) - self.upperLegLength) * self.s__q_LF_KFE) + (
                                                     ((((
                                                                    self.BASE2HAA_offset_y * self.s__q_LF_HAA) - self.BASE2HAA_offset_z) * self.s__q_LF_HFE) - (
                                                                  self.BASE2HAA_offset_x * self.c__q_LF_HFE)) * self.c__q_LF_KFE);
        ...
        self.LF_foot_Xh_fr_trunk[2, 3] = (((((
                                                         self.BASE2HAA_offset_y * self.s__q_LF_HAA) - self.BASE2HAA_offset_z) * self.s__q_LF_HFE) - (
                                                       self.BASE2HAA_offset_x * self.c__q_LF_HFE)) * self.s__q_LF_KFE) + (
                                                     ((- self.BASE2HAA_offset_x * self.s__q_LF_HFE) + ((
                                                                                                                   self.BASE2HAA_offset_z - (
                                                                                                                       self.BASE2HAA_offset_y * self.s__q_LF_HAA)) * self.c__q_LF_HFE) + self.upperLegLength) * self.c__q_LF_KFE) + self.lowerLegLength;
        ...
        self.RF_foot_Xh_fr_trunk[0, 3] = (((self.BASE2HAA_offset_x * self.s__q_RF_HFE) + (((
                                                                                                       self.BASE2HAA_offset_y * self.s__q_RF_HAA) - self.BASE2HAA_offset_z) * self.c__q_RF_HFE) - self.upperLegLength) * self.s__q_RF_KFE) + (
                                                     ((((
                                                                    self.BASE2HAA_offset_y * self.s__q_RF_HAA) - self.BASE2HAA_offset_z) * self.s__q_RF_HFE) - (
                                                                  self.BASE2HAA_offset_x * self.c__q_RF_HFE)) * self.c__q_RF_KFE);
        ...
        self.RF_foot_Xh_fr_trunk[2, 3] = (((((
                                                         self.BASE2HAA_offset_y * self.s__q_RF_HAA) - self.BASE2HAA_offset_z) * self.s__q_RF_HFE) - (
                                                       self.BASE2HAA_offset_x * self.c__q_RF_HFE)) * self.s__q_RF_KFE) + (
                                                     ((- self.BASE2HAA_offset_x * self.s__q_RF_HFE) + ((
                                                                                                                   self.BASE2HAA_offset_z - (
                                                                                                                       self.BASE2HAA_offset_y * self.s__q_RF_HAA)) * self.c__q_RF_HFE) + self.upperLegLength) * self.c__q_RF_KFE) + self.lowerLegLength;
        ...
        self.LH_foot_Xh_fr_trunk[0, 3] = (((- self.BASE2HAA_offset_x * self.s__q_LH_HFE) + (((
                                                                                                         self.BASE2HAA_offset_y * self.s__q_LH_HAA) - self.BASE2HAA_offset_z) * self.c__q_LH_HFE) - self.upperLegLength) * self.s__q_LH_KFE) + (
                                                     ((((
                                                                    self.BASE2HAA_offset_y * self.s__q_LH_HAA) - self.BASE2HAA_offset_z) * self.s__q_LH_HFE) + (
                                                                  self.BASE2HAA_offset_x * self.c__q_LH_HFE)) * self.c__q_LH_KFE);
        ...
        self.LH_foot_Xh_fr_trunk[2, 3] = (((((
                                                         self.BASE2HAA_offset_y * self.s__q_LH_HAA) - self.BASE2HAA_offset_z) * self.s__q_LH_HFE) + (
                                                       self.BASE2HAA_offset_x * self.c__q_LH_HFE)) * self.s__q_LH_KFE) + (
                                                     ((self.BASE2HAA_offset_x * self.s__q_LH_HFE) + ((
                                                                                                                 self.BASE2HAA_offset_z - (
                                                                                                                     self.BASE2HAA_offset_y * self.s__q_LH_HAA)) * self.c__q_LH_HFE) + self.upperLegLength) * self.c__q_LH_KFE) + self.lowerLegLength;
        ...
        self.RH_foot_Xh_fr_trunk[0, 3] = (((- self.BASE2HAA_offset_x * self.s__q_RH_HFE) + (((
                                                                                                         self.BASE2HAA_offset_y * self.s__q_RH_HAA) - self.BASE2HAA_offset_z) * self.c__q_RH_HFE) - self.upperLegLength) * self.s__q_RH_KFE) + (
                                                     ((((
                                                                    self.BASE2HAA_offset_y * self.s__q_RH_HAA) - self.BASE2HAA_offset_z) * self.s__q_RH_HFE) + (
                                                                  self.BASE2HAA_offset_x * self.c__q_RH_HFE)) * self.c__q_RH_KFE);
        ...
        self.RH_foot_Xh_fr_trunk[2, 3] = (((((
                                                         self.BASE2HAA_offset_y * self.s__q_RH_HAA) - self.BASE2HAA_offset_z) * self.s__q_RH_HFE) + (
                                                       self.BASE2HAA_offset_x * self.c__q_RH_HFE)) * self.s__q_RH_KFE) + (
                                                     ((self.BASE2HAA_offset_x * self.s__q_RH_HFE) + ((
                                                                                                                 self.BASE2HAA_offset_z - (
                                                                                                                     self.BASE2HAA_offset_y * self.s__q_RH_HAA)) * self.c__q_RH_HFE) + self.upperLegLength) * self.c__q_RH_KFE) + self.lowerLegLength;
        ...
        self.fr_trunk_Xh_LF_foot[0, 3] = (- self.lowerLegLength * self.c__q_LF_HFE * self.s__q_LF_KFE) - (
                    self.lowerLegLength * self.s__q_LF_HFE * self.c__q_LF_KFE) - (
                                                     self.upperLegLength * self.s__q_LF_HFE) + self.BASE2HAA_offset_x;
        ...
        self.fr_trunk_Xh_LF_foot[1, 2] = (self.s__q_LF_HAA * self.c__q_LF_HFE * self.c__q_LF_KFE) - (
                    self.s__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE);
        self.fr_trunk_Xh_LF_foot[1, 3] = (
                                                     self.lowerLegLength * self.s__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE) - (
                                                     self.lowerLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE * self.c__q_LF_KFE) - (
                                                     self.upperLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE) - (
        ...
        self.fr_trunk_Xh_LF_foot[2, 2] = (self.c__q_LF_HAA * self.c__q_LF_HFE * self.c__q_LF_KFE) - (
                    self.c__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE);
        self.fr_trunk_Xh_LF_foot[2, 3] = (
                                                     self.lowerLegLength * self.c__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE) - (
                                                     self.lowerLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE * self.c__q_LF_KFE) - (
                                                     self.upperLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE) - (
        ...
        self.fr_trunk_Xh_fr_LF_KFE[2, 3] = (- self.upperLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE) - (
                    self.BASE2HAA_offset_z * self.c__q_LF_HAA);
        ...
        self.fr_trunk_Xh_RF_foot[0, 3] = (- self.lowerLegLength * self.c__q_RF_HFE * self.s__q_RF_KFE) - (
                    self.lowerLegLength * self.s__q_RF_HFE * self.c__q_RF_KFE) - (
                                                     self.upperLegLength * self.s__q_RF_HFE) + self.BASE2HAA_offset_x;
        ...
        self.fr_trunk_Xh_RF_foot[1, 2] = (self.s__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) - (
                    self.s__q_RF_HAA * self.c__q_RF_HFE * self.c__q_RF_KFE);
        self.fr_trunk_Xh_RF_foot[1, 3] = (
                                                     - self.lowerLegLength * self.s__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) + (
                                                     self.lowerLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE * self.c__q_RF_KFE) + (
                                                     self.upperLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE) + (
        ...
        self.fr_trunk_Xh_RF_foot[2, 2] = (self.c__q_RF_HAA * self.c__q_RF_HFE * self.c__q_RF_KFE) - (
                    self.c__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE);
        self.fr_trunk_Xh_RF_foot[2, 3] = (
                                                     self.lowerLegLength * self.c__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) - (
                                                     self.lowerLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE * self.c__q_RF_KFE) - (
                                                     self.upperLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE) - (
        ...
        self.fr_trunk_Xh_fr_RF_KFE[2, 3] = (- self.upperLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE) - (
                    self.BASE2HAA_offset_z * self.c__q_RF_HAA);
        ...
        self.fr_trunk_Xh_LH_foot[0, 3] = (- self.lowerLegLength * self.c__q_LH_HFE * self.s__q_LH_KFE) - (
                    self.lowerLegLength * self.s__q_LH_HFE * self.c__q_LH_KFE) - (
        ...
        self.fr_trunk_Xh_LH_foot[1, 2] = (self.s__q_LH_HAA * self.c__q_LH_HFE * self.c__q_LH_KFE) - (
                    self.s__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE);
        self.fr_trunk_Xh_LH_foot[1, 3] = (
                                                     self.lowerLegLength * self.s__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE) - (
                                                     self.lowerLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE * self.c__q_LH_KFE) - (
                                                     self.upperLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE) - (
        ...
        self.fr_trunk_Xh_LH_foot[2, 2] = (self.c__q_LH_HAA * self.c__q_LH_HFE * self.c__q_LH_KFE) - (
                    self.c__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE);
        self.fr_trunk_Xh_LH_foot[2, 3] = (
                                                     self.lowerLegLength * self.c__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE) - (
                                                     self.lowerLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE * self.c__q_LH_KFE) - (
                                                     self.upperLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE) - (
        ...
        self.fr_trunk_Xh_fr_LH_KFE[2, 3] = (- self.upperLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE) - (
                    self.BASE2HAA_offset_z * self.c__q_LH_HAA);
        ...
        self.fr_trunk_Xh_RH_foot[0, 3] = (- self.lowerLegLength * self.c__q_RH_HFE * self.s__q_RH_KFE) - (
                    self.lowerLegLength * self.s__q_RH_HFE * self.c__q_RH_KFE) - (
        ...
        self.fr_trunk_Xh_RH_foot[1, 2] = (self.s__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) - (
                    self.s__q_RH_HAA * self.c__q_RH_HFE * self.c__q_RH_KFE);
        self.fr_trunk_Xh_RH_foot[1, 3] = (
                                                     - self.lowerLegLength * self.s__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) + (
                                                     self.lowerLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE * self.c__q_RH_KFE) + (
                                                     self.upperLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE) + (
        ...
        self.fr_trunk_Xh_RH_foot[2, 2] = (self.c__q_RH_HAA * self.c__q_RH_HFE * self.c__q_RH_KFE) - (
                    self.c__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE);
        self.fr_trunk_Xh_RH_foot[2, 3] = (
                                                     self.lowerLegLength * self.c__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) - (
                                                     self.lowerLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE * self.c__q_RH_KFE) - (
                                                     self.upperLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE) - (
        ...
        self.fr_trunk_Xh_fr_RH_KFE[2, 3] = (- self.upperLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE) - (
                    self.BASE2HAA_offset_z * self.c__q_RH_HAA);
    ...
    def update_jacobians(self, q):
        ...
        self.fr_trunk_J_LF_foot[4 - 1, 2 - 1] = (self.lowerLegLength * self.s__q_LF_HFE * self.s__q_LF_KFE) - (
                    self.lowerLegLength * self.c__q_LF_HFE * self.c__q_LF_KFE) - (
                                                            self.upperLegLength * self.c__q_LF_HFE);
        self.fr_trunk_J_LF_foot[4 - 1, 3 - 1] = (self.lowerLegLength * self.s__q_LF_HFE * self.s__q_LF_KFE) - (
                    self.lowerLegLength * self.c__q_LF_HFE * self.c__q_LF_KFE);
        self.fr_trunk_J_LF_foot[5 - 1, 1 - 1] = (
                                                            self.lowerLegLength * self.c__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE) - (
                                                            self.lowerLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE * self.c__q_LF_KFE) - (
                                                            self.upperLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE) - (
                                                            self.BASE2HAA_offset_z * self.c__q_LF_HAA);
        self.fr_trunk_J_LF_foot[5 - 1, 2 - 1] = (
                                                            self.lowerLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) + (
                                                            self.lowerLegLength * self.s__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE) + (
                                                            self.upperLegLength * self.s__q_LF_HAA * self.s__q_LF_HFE);
        self.fr_trunk_J_LF_foot[5 - 1, 3 - 1] = (
                                                            self.lowerLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) + (
                                                            self.lowerLegLength * self.s__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE);
        self.fr_trunk_J_LF_foot[6 - 1, 1 - 1] = (
                                                            - self.lowerLegLength * self.s__q_LF_HAA * self.s__q_LF_HFE * self.s__q_LF_KFE) + (
                                                            self.lowerLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE * self.c__q_LF_KFE) + (
                                                            self.upperLegLength * self.s__q_LF_HAA * self.c__q_LF_HFE) + (
                                                            self.BASE2HAA_offset_z * self.s__q_LF_HAA);
        self.fr_trunk_J_LF_foot[6 - 1, 2 - 1] = (
                                                            self.lowerLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) + (
                                                            self.lowerLegLength * self.c__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE) + (
                                                            self.upperLegLength * self.c__q_LF_HAA * self.s__q_LF_HFE);
        self.fr_trunk_J_LF_foot[6 - 1, 3 - 1] = (
                                                            self.lowerLegLength * self.c__q_LF_HAA * self.c__q_LF_HFE * self.s__q_LF_KFE) + (
                                                            self.lowerLegLength * self.c__q_LF_HAA * self.s__q_LF_HFE * self.c__q_LF_KFE);
        ...
        self.fr_trunk_J_RF_foot[4 - 1, 2 - 1] = (self.lowerLegLength * self.s__q_RF_HFE * self.s__q_RF_KFE) - (
                    self.lowerLegLength * self.c__q_RF_HFE * self.c__q_RF_KFE) - (
                                                            self.upperLegLength * self.c__q_RF_HFE);
        self.fr_trunk_J_RF_foot[4 - 1, 3 - 1] = (self.lowerLegLength * self.s__q_RF_HFE * self.s__q_RF_KFE) - (
                    self.lowerLegLength * self.c__q_RF_HFE * self.c__q_RF_KFE);
        self.fr_trunk_J_RF_foot[5 - 1, 1 - 1] = (
                                                            - self.lowerLegLength * self.c__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) + (
                                                            self.lowerLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE * self.c__q_RF_KFE) + (
                                                            self.upperLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE) + (
                                                            self.BASE2HAA_offset_z * self.c__q_RF_HAA);
        self.fr_trunk_J_RF_foot[5 - 1, 2 - 1] = (
                                                            - self.lowerLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) - (
                                                            self.lowerLegLength * self.s__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE) - (
                                                            self.upperLegLength * self.s__q_RF_HAA * self.s__q_RF_HFE);
        self.fr_trunk_J_RF_foot[5 - 1, 3 - 1] = (
                                                            - self.lowerLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) - (
                                                            self.lowerLegLength * self.s__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE);
        self.fr_trunk_J_RF_foot[6 - 1, 1 - 1] = (
                                                            - self.lowerLegLength * self.s__q_RF_HAA * self.s__q_RF_HFE * self.s__q_RF_KFE) + (
                                                            self.lowerLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE * self.c__q_RF_KFE) + (
                                                            self.upperLegLength * self.s__q_RF_HAA * self.c__q_RF_HFE) + (
                                                            self.BASE2HAA_offset_z * self.s__q_RF_HAA);
        self.fr_trunk_J_RF_foot[6 - 1, 2 - 1] = (
                                                            self.lowerLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) + (
                                                            self.lowerLegLength * self.c__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE) + (
                                                            self.upperLegLength * self.c__q_RF_HAA * self.s__q_RF_HFE);
        self.fr_trunk_J_RF_foot[6 - 1, 3 - 1] = (
                                                            self.lowerLegLength * self.c__q_RF_HAA * self.c__q_RF_HFE * self.s__q_RF_KFE) + (
                                                            self.lowerLegLength * self.c__q_RF_HAA * self.s__q_RF_HFE * self.c__q_RF_KFE);
        ...
        self.fr_trunk_J_LH_foot[4 - 1, 2 - 1] = (self.lowerLegLength * self.s__q_LH_HFE * self.s__q_LH_KFE) - (
                    self.lowerLegLength * self.c__q_LH_HFE * self.c__q_LH_KFE) - (
                                                            self.upperLegLength * self.c__q_LH_HFE);
        self.fr_trunk_J_LH_foot[4 - 1, 3 - 1] = (self.lowerLegLength * self.s__q_LH_HFE * self.s__q_LH_KFE) - (
                    self.lowerLegLength * self.c__q_LH_HFE * self.c__q_LH_KFE);
        self.fr_trunk_J_LH_foot[5 - 1, 1 - 1] = (
                                                            self.lowerLegLength * self.c__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE) - (
                                                            self.lowerLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE * self.c__q_LH_KFE) - (
                                                            self.upperLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE) - (
                                                            self.BASE2HAA_offset_z * self.c__q_LH_HAA);
        self.fr_trunk_J_LH_foot[5 - 1, 2 - 1] = (
                                                            self.lowerLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) + (
                                                            self.lowerLegLength * self.s__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE) + (
                                                            self.upperLegLength * self.s__q_LH_HAA * self.s__q_LH_HFE);
        self.fr_trunk_J_LH_foot[5 - 1, 3 - 1] = (
                                                            self.lowerLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) + (
                                                            self.lowerLegLength * self.s__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE);
        self.fr_trunk_J_LH_foot[6 - 1, 1 - 1] = (
                                                            - self.lowerLegLength * self.s__q_LH_HAA * self.s__q_LH_HFE * self.s__q_LH_KFE) + (
                                                            self.lowerLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE * self.c__q_LH_KFE) + (
                                                            self.upperLegLength * self.s__q_LH_HAA * self.c__q_LH_HFE) + (
                                                            self.BASE2HAA_offset_z * self.s__q_LH_HAA);
        self.fr_trunk_J_LH_foot[6 - 1, 2 - 1] = (
                                                            self.lowerLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) + (
                                                            self.lowerLegLength * self.c__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE) + (
                                                            self.upperLegLength * self.c__q_LH_HAA * self.s__q_LH_HFE);
        self.fr_trunk_J_LH_foot[6 - 1, 3 - 1] = (
                                                            self.lowerLegLength * self.c__q_LH_HAA * self.c__q_LH_HFE * self.s__q_LH_KFE) + (
                                                            self.lowerLegLength * self.c__q_LH_HAA * self.s__q_LH_HFE * self.c__q_LH_KFE);
        ...
        self.fr_trunk_J_RH_foot[4 - 1, 2 - 1] = (self.lowerLegLength * self.s__q_RH_HFE * self.s__q_RH_KFE) - (
                    self.lowerLegLength * self.c__q_RH_HFE * self.c__q_RH_KFE) - (
                                                            self.upperLegLength * self.c__q_RH_HFE);
        self.fr_trunk_J_RH_foot[4 - 1, 3 - 1] = (self.lowerLegLength * self.s__q_RH_HFE * self.s__q_RH_KFE) - (
                    self.lowerLegLength * self.c__q_RH_HFE * self.c__q_RH_KFE);
        self.fr_trunk_J_RH_foot[5 - 1, 1 - 1] = (
                                                            - self.lowerLegLength * self.c__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) + (
                                                            self.lowerLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE * self.c__q_RH_KFE) + (
                                                            self.upperLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE) + (
                                                            self.BASE2HAA_offset_z * self.c__q_RH_HAA);
        self.fr_trunk_J_RH_foot[5 - 1, 2 - 1] = (
                                                            - self.lowerLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) - (
                                                            self.lowerLegLength * self.s__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE) - (
                                                            self.upperLegLength * self.s__q_RH_HAA * self.s__q_RH_HFE);
        self.fr_trunk_J_RH_foot[5 - 1, 3 - 1] = (
                                                            - self.lowerLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) - (
                                                            self.lowerLegLength * self.s__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE);
        self.fr_trunk_J_RH_foot[6 - 1, 1 - 1] = (
                                                            - self.lowerLegLength * self.s__q_RH_HAA * self.s__q_RH_HFE * self.s__q_RH_KFE) + (
                                                            self.lowerLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE * self.c__q_RH_KFE) + (
                                                            self.upperLegLength * self.s__q_RH_HAA * self.c__q_RH_HFE) + (
                                                            self.BASE2HAA_offset_z * self.s__q_RH_HAA);
        self.fr_trunk_J_RH_foot[6 - 1, 2 - 1] = (
                                                            self.lowerLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) + (
                                                            self.lowerLegLength * self.c__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE) + (
                                                            self.upperLegLength * self.c__q_RH_HAA * self.s__q_RH_HFE);
        self.fr_trunk_J_RH_foot[6 - 1, 3 - 1] = (
                                                            self.lowerLegLength * self.c__q_RH_HAA * self.c__q_RH_HFE * self.s__q_RH_KFE) + (
                                                            self.lowerLegLength * self.c__q_RH_HAA * self.s__q_RH_HFE * self.c__q_RH_KFE);
        ...
        return self.fr_trunk_J_LF_foot[3:6, :], self.fr_trunk_J_RF_foot[3:6, :], self.fr_trunk_J_LH_foot[3:6,
                                                                                 :], self.fr_trunk_J_RH_foot[3:6, :]
