...
ik_LH = ikpy.chain.Chain.from_urdf_file(
    "../resources/urdfs/hyq/urdf/leg/hyq_leg_LH.urdf")
ik_RH = ikpy.chain.Chain.from_urdf_file(
    "../resources/urdfs/hyq/urdf/leg/hyq_leg_RH.urdf")
...
print(target_frame)
ik_LF = ikpy.chain.Chain.from_urdf_file(
    "../resources/urdfs/hyq/urdf/leg/hyq_leg_LF.urdf")
...
print(target_frame)
ik_RF = ikpy.chain.Chain.from_urdf_file(
    "../resources/urdfs/hyq/urdf/leg/hyq_leg_RF.urdf")
